...
parser = argparse.ArgumentParser(description='Student-teacher MMD-flow experiment')
...
# Network parameters
parser.add_argument('--bias',   action='store_true',  help='set to include bias in the network parameters')
